...
public enum Rank {
	...
	TEN(10), JACK(10), QUEEN(10), KING(10), ACE(11), SOFT_ACE(1);
	private int value;
...
*Add a one-arg constructor to Rank and set the value field to
* 2-10 for numbers, 10 for JACK, QUEEN, and KING, and 11 for ACE.
